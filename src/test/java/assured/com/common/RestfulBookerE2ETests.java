package assured.com.common;

import static assured.com.data.restfulbooker.TokenBuilder.getToken;
import static io.restassured.RestAssured.given;
import static org.hamcrest.Matchers.*;

import assured.com.data.restfulbooker.BookingData;
import assured.com.data.restfulbooker.PartialBookingData;
import assured.com.data.restfulbooker.Tokencreds;
import assured.com.data.restfulbooker.BookingDataBuilder;
...
public class RestfulBookerE2ETests extends BaseSetup {
    ...
    public void testSetup() {
        ...
        updatedBooking = BookingDataBuilder.getbookingData();
        partialUpdateBooking = BookingDataBuilder.getpartialBookingData();
        tokenCreds = getToken();
    }
